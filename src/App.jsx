        ...
        <div>
            <main className="bg-gray-900 flex h-screen items-center justify-center overflow-auto p-3 w-full">
                <div className="bg-gray-800 flex flex-col gap-4 h-auto justify-self-center p-3 place-items-center rounded-lg shadow-xl w-auto overflow-auto">
                    ...
                    <form className="flex flex-col gap-5 h-auto p-2 place-items-center w-auto" data-pg-collapsed>
                        ...
                        <div className="flex flex-wrap gap-5 items-center place-content-center">
                            <div className="flex gap-2 items-center justify-center">
                                <input
                                    ...
                                    id=""
                                />
                                <label htmlFor="length" className="capitalize font-semibold text-yellow-600">
                                    Length: {length}
                                </label>
                            </div>
                            <div className="flex gap-2 items-center justify-center">
                                ...
                                />
                                <label htmlFor="character" className="capitalize font-semibold text-yellow-600">
                                    Characters
                                </label>
                            </div>
                            <div className="flex gap-2 items-center justify-center">
                                ...
                                />
                                <label htmlFor="number" className="capitalize font-semibold text-yellow-600">
                                    Numbers
                                </label>
                            </div>
                        </div>
